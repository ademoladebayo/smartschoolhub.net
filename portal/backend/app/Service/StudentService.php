...
class StudentService
{
    ...
    public function getResult(Request $request = null, $class_id = null, $subject_id = null, $student_id = null, $session = null, $term = null)
    {
        ...
        return response()->json(['success' => true, 'message' => 'Result fetch was successfull.', 'settings' => json_decode($result_settings), 'result' => $result, 'percentage' => floor($percentage) . '%', 'grade_position' => $grade_position, 'no_student' => $no_student]);
    }
