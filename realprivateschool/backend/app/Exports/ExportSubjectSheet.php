...
class ExportSubjectSheet implements FromCollection, ShouldAutoSize, WithEvents, WithHeadings
{
    ...
    public function collection()
    {
        ...
        $data =  DB::table('subject_registration')
            ...
            ->select('subject_registration.subject_id', 'subject.subject_name', 'class.class_name', DB::raw('CONCAT(student.first_name, " ", student.last_name) as student'), 'subject_registration.first_ca', 'subject_registration.second_ca', 'subject_registration.examination')
            ->get();
    ...
    {
        return ['SUBJECT ID', 'SUBJECT', 'CLASS', 'STUDENT', 'TEST 1', 'TEST 2', 'EXAMINATION'];
    }
